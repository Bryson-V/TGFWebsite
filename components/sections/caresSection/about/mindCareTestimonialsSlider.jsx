...
import testimonialsData from "@/content/site-data/mindTestimonials.json";
import styles from "./mindCareTestimonialsSlider.module.css";

export default function MindCareTestimonialsSlider() {
