...
import styles from "./endoCTA.module.css";

export default function EndoCtaBanner() {
  return (
        ...
        <div className={styles.noticeHeader}>
          ...
          <div>
            ...
            <p className={styles.noticeDesc}>
              <strong>Our Endocrinology Clinic is an outpatient care provider.</strong> If you are experiencing severe hyper/hypoglycemia or a medical emergency, please call 911 or visit the nearest emergency room immediately.
            </p>
          </div>
        </div>
